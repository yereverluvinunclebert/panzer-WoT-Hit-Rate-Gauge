...
var mainWindow, background, surround, switchFacesButton, hitrateMaxText, hitratePercText,hitrateMaxTextArea,
        hitratePercTextArea,
...
// macintosh
var hitratePercTextAreaxo = 295, hitratePercTextAreayo = 190;

// windows
var hitratePercTextxo = 315, hitratePercTextyo = 212;
...
var widgetName = "panzer WoT hitrate.widget";
var applicationID = "0d5c24439df77a9ad56451fcaa3ca66a"; // the applications ID from WG for YahooWidgetWoTHitRate
...
function sizeClock() {
    ...
    // macintosh
    hitratePercTextArea.size = Math.round(22 * scale);
    hitratePercTextArea.hOffset = Math.round(hitratePercTextAreaxo * scale);
    hitratePercTextArea.vOffset = Math.round(hitratePercTextAreayo * scale);

    // WINDOWS

    hitratePercText.size = Math.round(22 * scale);
    hitratePercText.hOffset = Math.round(hitratePercTextxo * scale);
    hitratePercText.vOffset = Math.round(hitratePercTextyo * scale);
...
*/
    ...
    hitratePercText.data = eee.toFixed(1); // returns " 23" (with one space)
    hitratePercText.tooltip = "user " + preferences.wotUserId.value + " Hit Rate = " + hitratePercText.data + "%";

    hitratePercTextArea.data = hitratePercText.data
    hitratePercTextArea.tooltip = "user " + preferences.wotUserId.value + " Hit Rate = " + hitratePercText.data + "%";
    ...
    buildVitality(currIcon, String(hitratePercTextArea.data)); // build the dock vitality
}
//=====================
//End function
//=====================
...
function setTextAreas() {
    if (system.platform === "macintosh") {
      hitratePercTextArea.visible = true;
    } else {
      hitratePercText.visible = true;
    }
}
//=====================
//End function
...
background.onMultiClick = function() {
	...
	//updatehitrate(); // the interval is temporarily reduced and the update is triggered quickly
};
//=====================
//End function
//=====================
